...
export const UpgradeViewLoading = () => {
  return (
    <LoadingState title="Loading Upgrade" description="This may take a few seconds" />
  )
}

export const UpgradeViewError = () => {
  return (
    <ErrorState title="Failed to Load Upgrade" description="Something went wrong. Please try again later." />
  )
}